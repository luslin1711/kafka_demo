...
public class Consumer implements Runnable{
    ...
    public void run() {
        ...
        DefaultRebalanceListener rebalanceListener = new DefaultRebalanceListener(consumer);
        try {
            ...
            while (true) {
                ...
                for ( ConsumerRecord <String, String> record : records ) {
                    ...
                    rebalanceListener.put(new TopicPartition(record.topic(), record.partition()), new OffsetAndMetadata(record.offset() + 1, "no medata"));
                }
